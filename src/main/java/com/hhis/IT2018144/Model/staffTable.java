...
public class staffTable {
	...
	public staffTable(long id, String name, String gender, String address, String email, String phoneNo, String nIC,
			String dOB, String joindDate, long hospitalId, long jobExpiance, String staffRole, String username) {
		super();
		this.id = id;
		this.name = name;
		this.gender = gender;
